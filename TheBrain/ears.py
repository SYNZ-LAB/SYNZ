...
def process_audio():
    ...
    try:
        ...
        if text:
             ...
             # These phrases are generated by Whisper when processing silence.
             clean_text = text.lower().strip(".?! ")
             if not clean_text or clean_text in HALLUCINATION_FILTERS or any(h in clean_text for h in HALLUCINATION_FILTERS):
                  print(f"[EARS] Filtered Hallucination: '{text}'")
                  return
